import { runAdb, runAdbBinary } from '../adb/adbManager';
 ...
 */
export async function listDirectory(serial: string, remoteDir: string = '/storage/emulated/0/'): Promise<FileItem[]> {
 ...
 */
export async function createDirectory(serial: string, remoteDir: string): Promise<void> {
 ...
 */
export async function deleteRemoteFile(serial: string, remotePath: string): Promise<void> {
 ...
 */
export async function renameRemoteFile(serial: string, oldPath: string, newPath: string): Promise<void> {
 ...
 */
export async function getFilePreview(serial: string, remotePath: string): Promise<FilePreviewData> {
